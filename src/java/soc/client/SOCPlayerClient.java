...
public class SOCPlayerClient extends Applet implements Runnable, ActionListener
{
    ...
    public synchronized boolean put(String s)
    {
        ...
        D.ebugPrintln("OUT - put" + SOCMessage.toMsg(s));
        ...
        try
        {
	    D.ebugPrintln("OUT - writing" + SOCMessage.toMsg(s));
            out.writeUTF(s);
        }
        catch (IOException e)
        {
    ...
    protected void handleJOINGAMEAUTH(SOCJoinGameAuth mes)
    {
        ...
        if (ga != null)
        {
	    D.ebugPrintln("starting SOCPlayerInterface");
    ...
    public boolean doLocalCommand(String ch, String cmd)
    {
        ...
        if (cmd.startsWith("\\ignore "))
        {
            ...
            Enumeration enumr = ignoreList.elements();

            while (enumr.hasMoreElements())
            {
                String s = (String) enumr.nextElement();
                fr.print("* " + s);
            }
